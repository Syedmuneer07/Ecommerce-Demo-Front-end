        ...
        <div className="row justify-content-center align-items-center min-vh-100">
          <div className="col-12 col-sm-10 col-md-8 col-lg-5 col-xl-5">
            ...
            <div className="auth-card">
              ...
              <p className="auth-subtitle text-center mb-4">Sign in to continue shopping</p>
              ...
              <form className='login-form' onSubmit={(e) => handleSubmit(e)}>
                ...
                <button type="submit" className="auth-button btn w-100 mb-3">Sign In</button>
              </form>
              
              <div className="auth-footer text-center">
                <p className="mb-0">Don't have an account? <Link to="/register" className="text-decoration-none">Create Account</Link></p>
              </div>
            </div>
